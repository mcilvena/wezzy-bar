...
function M.get_wezterm_overrides()
  return current_config.wezterm_config_overrides or default_config.wezterm_config_overrides
end
...
function M.apply_wezterm_overrides(wezterm_config)
  ...
  if current_config.theme and current_config.theme.tab_bar_background then
    ...
    wezterm_config.colors.tab_bar.background = current_config.theme.tab_bar_background
  end
