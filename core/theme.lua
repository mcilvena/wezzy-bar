...
function M.get_colors()
  ...
  local wezterm_config = wezterm.config_builder and wezterm.config_builder()
    or {}
  ...
  if not scheme then
    scheme = builtin_schemes["default"]
      or {
        foreground = "#ffffff",
        background = "#000000",
        cursor_bg = "#ffffff",
  ...
  local subtle_fg = scheme.ansi and scheme.ansi[8] -- Bright black (subtle)
    or scheme.ansi and scheme.ansi[7] -- Light gray
    or scheme.foreground -- Fallback to normal foreground
  ...
  return {
    ...
    tab_bar = scheme.tab_bar or {
      background = plugin_config.theme
          and plugin_config.theme.tab_bar_background
        or scheme.background,
      active_tab = {
        -- Try to use Catppuccin's accent colors: lavender, blue, or selection
        bg_color = scheme.indexed and scheme.indexed[16] -- Catppuccin lavender
          or scheme.brights and scheme.brights[5] -- Bright blue
          or scheme.selection_bg -- Selection color
          or scheme.ansi[5], -- Regular blue
        fg_color = scheme.background or scheme.cursor_fg, -- Contrasting text
      },
      inactive_tab = {
        bg_color = plugin_config.theme
            and plugin_config.theme.tab_bar_background
          or scheme.background,
